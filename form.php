...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
    <div class="container">
     ...
     <label for="home"><b>Address</b></label>
...
if(!$conn) {
 ...
 $errFullname=$errUsername=$errPhone=$errAddress=$errPassword="";
     if(isset($_POST['add'])){
...
$sql = "INSERT INTO Contact(userName, fullName, phone, home, pass)
		 VALUES('$FullName', '$UserName', '$Phone', '$Address', '$Password)";
